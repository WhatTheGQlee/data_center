...
int main(int argc, char* argv[]) {
  ...
  if (argc != 5) {
    ...
    printf(
        "Example:/home/gqlee/project/bin/procctl 120 "
        "/home/gqlee/project/bin/execsql "
        "/home/gqlee/project/data_server/sql/cleardata.sql "
        "\"127.0.0.1,root,123456,data_server,3306\" "
        "utf8 /home/gqlee/project/log/execsql.log\n\n");

    printf("这是一个工具程序，用于执行一个sql脚本文件。\n");
    printf(
        "sqlfile "
        "sql脚本文件名，每条sql语句可以多行书写，分号表示一条sql语句的结束，不"
        "支持注释。\n");
